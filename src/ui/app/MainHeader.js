...
export class MainHeader extends TranslationMixin(LitElement) {
    static properties = {
    ...
    async _handleAskClick() {
        ...
        try {
            ...
            console.error('[MainHeader] IPC invoke for ask button failed:', error);
        }
            ...
            <div class="header" @mousedown=${this.handleMouseDown}>
                ...
                <div class="middle-actions">
                    ...
                    <div class="header-actions" @click=${() => this._handleToggleAllWindowsVisibility()}>
                        <div class="action-text">
                            <div class="action-text-content">${this.t('header.toggleVisibility')}</div>
                        </div>
                        <div class="icon-container">
