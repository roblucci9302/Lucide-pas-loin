    ...
    render() {
        ...
        return html`
            <div class="container" style="height: ${containerHeight}px">
                ...
                <h1 class="title">${this.t('permissions.title')}</h1>
                ...
                <div class="form-content ${allGranted ? 'all-granted' : ''}">
                    ${!allGranted ? html`
                        ...
                        <div class="permission-status">
                            ...
                            <div class="permission-item ${this.screenGranted === 'granted' ? 'granted' : ''}">
                                ${this.screenGranted === 'granted' ? html`
                                    ...
                                    <span>${this.t('permissions.screenGranted')}</span>
                                ` : html`
                                    <svg class="permission-icon" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.804A1 1 0 0113 18H7a1 1 0 01-.707-1.707l.804-.804L7.22 15H5a2 2 0 01-2-2V5zm5.771 7H5V5h10v7H8.771z" clip-rule="evenodd" />
                                    </svg>
                                    <span>${this.t('permissions.screen')}</span>
                                `}
                            </div>
                            ...
                            ${isKeychainRequired ? html`
                                <div class="permission-item ${this.keychainGranted === 'granted' ? 'granted' : ''}">
                                    ${this.keychainGranted === 'granted' ? html`
                                        ...
                                        <span>${this.t('permissions.encryptionGranted')}</span>
                                    ` : html`
                                        <svg class="permission-icon" viewBox="0 0 20 20" fill="currentColor">
                                        ...
                                        <span>${this.t('permissions.encryption')}</span>
                                    `}
                                </div>
                            ` : ''}
                        </div>
                        ...
                        >
                            ${this.microphoneGranted === 'granted' ? this.t('permissions.microphoneAccessGranted') : this.t('permissions.grantMicrophone')}
                        </button>
                        ...
                        >
                            ${this.screenGranted === 'granted' ? this.t('permissions.screenRecordingGranted') : this.t('permissions.grantScreen')}
                        </button>
                        ...
                        ${isKeychainRequired ? html`
                            ...
                            >
                                ${this.keychainGranted === 'granted' ? this.t('permissions.encryptionEnabled') : this.t('permissions.enableEncryption')}
                            </button>
                            <div class="subtitle" style="visibility: ${this.keychainGranted === 'granted' ? 'hidden' : 'visible'}">
                                ${this.t('permissions.keychainInstructions')}
                            </div>
                        ` : ''}
                    ` : html`
                        <button 
