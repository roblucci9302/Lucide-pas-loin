...
const notificationBridge = require('./modules/notificationBridge'); // Phase 13: Desktop Notifications
...
module.exports = {
    ...
    initialize() {
        ...
        notificationBridge.initialize(); // Phase 13: Desktop Notifications
